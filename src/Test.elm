    ...
    <|
        Element.column [ width (px 800), height shrink, centerY, centerX, spacing 36, padding 10, explain Debug.todo ]
            ...
            , Input.text
                ...
                { text = model.textst
                , placeholder = Just (Input.placeholder [] (text "PLEEAAAAASEEEE WORKKKK"))
                , onChange = \new -> Update { model | textst = new }
                , label = Input.labelAbove [ Font.size 14, Font.underline ] (text "Input the TEXTU HERU:")
                }
            , Input.radio
                [ spacing 12
            ...
            , Input.username
                ...
                { text = model.username
                , placeholder = Just (Input.placeholder [] (text "Type your username here"))
